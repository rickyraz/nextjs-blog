...
export function getSortedPostsData() {
  ...
  // Me mapping semua article yang ber ekstensi .md lalu diread menjadi string dan di parse metadata (---) nya
...
// added the async keyword to getPostData because we need to use await for remark.
